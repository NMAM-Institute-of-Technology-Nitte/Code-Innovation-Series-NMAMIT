...
<html lang="en">
  <head>
    ...
    <title>EDUCARE | ADD COURSES</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="container text-center" style="margin-top: 100px;">
      <form class="myForm" action="addcourses.php" method="post" autocomplete="off">
        <h1 style="font-weight: bolder;color: orangered;font-size:4.5vw">Add new course</h1><hr>
        <div class="form-row">
        ...
        <div class="form-row">
          <div class="form-group col-md-6 offset-md-3">
            ...
            <input type="number" class="form-control" id="course_cost" name="course_cost" required>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-6 offset-md-3">
