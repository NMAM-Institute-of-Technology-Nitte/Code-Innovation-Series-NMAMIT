...
<html lang="en">
  ...
  <body>
    ...
    <div class="container text-center" style="margin-top: 100px;">
      <form class="myForm" action="modifyCoursesFirstPageSubmit.php" method="post" autocomplete="off">
        <h1 style="font-weight: bolder;color: orangered;font-size:4.5vw">Modify a course</h1><hr>
        <div class="form-row">
          <div class="form-group col-md-6 offset-md-3">
            <label for="course_id" style="font-weight: bolder;color: white;">Course ID</label>
